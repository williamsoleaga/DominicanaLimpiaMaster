...
namespace DominicanaLimpia.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public List<Combo> LlenarReporteFormulario()
        {
            ...
            Combo.Add(new Combo { Indice = 6, Value = "3- METAS DOCENTES Y PERSONAL ADMINISTRATIVO" });
            ...
            Combo.Add(new Combo { Indice = 17, Value = "13- DIASESOL NEUMATICOS" });
            Combo.Add(new Combo { Indice = 16, Value = "14- DIASESOL PLASTICOS" });
            ...
            Combo.Add(new Combo { Indice = 8, Value = "18- METAS PUNTOS LIMPIOS" });   //aqui va el 18 ojo revisar klk con este
            Combo.Add(new Combo { Indice = 21, Value = "19- ENTREGA DE MONTA CARGAS" });
